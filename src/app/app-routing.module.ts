...
{path:'patent-search',component:PatentSearchComponent},
{path:'provisional-patent',component:ProvisionalPatentComponent},
{path:'permanent-patent',component:PermanentPatentComponent},
{path:'trademark-registration',component:TrademarkRegistrationComponent},
{path:'trademark-objection-reply',component:TrademarkObjectionReplyComponent},
{path:'trademark-opposition',component:TrademarkOppositionComponent},
{path:'trademark-assignment',component:TrademarkAssignmentComponent},
{path:'trademark-renewal',component:TrademarkRenewalComponent},
{path:'accounting-and-bookkeeping',component:AccountingAndBookkeepingComponent},
{path:'close-private-limited-company',component:ClosePrivateLimitedCompanyComponent},
{path:'close-limit-liablity-partnership',component:CloseLimitLiablityPartnershipComponent},
{path:'close-one-person-company',component:CloseOnePersonCompanyComponent},
{path:'dissolve-partnership-firm',component:DissolvePartnershipFirmComponent},
{path:'annual-compliance-private-limited-company',component:AnnualCompliancePrivateLimitedCompanyComponent},
{path:'annual-filing-limited-liablity-partnership',component:AnnualFilingLimitedLiablityPartnershipComponent},
{path:'file-dir-three-kyc',component:FileDirThreeKycComponent},
{path:'file-inc-twenty-a',component:FileIncTwentyAComponent},
{path:'file-inc-twenty-two-a',component:FileIncTwentyTwoAComponent},
{path:'add-remove-director',component:AddRemoveDirectorComponent},
{path:'add-remove-partner',component:AddRemovePartnerComponent},
{path:'change-business-activity',component:ChangeBusinessActivityComponent},
{path:'change-registered-office',component:ChangeRegisteredOfficeComponent},
{path:'change-company-name',component:ChangeCompanyNameComponent},
{path:'change-limited-liablity-partnership-agreement',component:ChangeLimitedLiablityPartnershipAgreementComponent},
{path:'change-partnership-deed',component:ChangePartnershipDeedComponent},
{path:'increase-authorised-share-capital',component:IncreaseAuthorisedShareCapitalComponent},
{path:'essential-business-agreement-kit',component:EssentialBusinessAgreementKitComponent},
{path:'residential-lease-deed',component:ResidentialLeaseDeedComponent},
{path:'commercial-lease-deed',component:CommercialLeaseDeedComponent},
{path:'notice-to-vacate-tenant',component:NoticeToVacateTenantComponent},
{path:'agreement-extension',component:AgreementExtensionComponent},
{path:'independent-contractor-agreement',component:IndependentContractorAgreementComponent},
{path:'memorandum-of-understanding',component:MemorandumOfUnderstandingComponent},
{path:'nda-third-party',component:NdaThirdPartyComponent},
{path:'website-disclaimer-policy',component:WebsiteDisclaimerPolicyComponent},
...
{path:'termination-of-agreement',component:TerminationOfAgreementComponent},
{path:'bill-of-sale',component:BillOfSaleComponent},
{path:'direct-selling-agreement',component:DirectSellingAgreementComponent},
{path:'estimate-sample',component:EstimateSampleComponent},
{path:'final-invoice',component:FinalInvoiceComponent},
{path:'purchase-order',component:PurchaseOrderComponent},
{path:'statement-of-work',component:StatementOfWorkComponent},
{path:'appointment-letter',component:AppointmentLetterComponent},
{path:'completion-of-probation-letter',component:CompletionOfProbationLetterComponent},
{path:'employee-termination-notice',component:EmployeeTerminationNoticeComponent},
{path:'employee-contract',component:EmployeeContractComponent},
{path:'employment-agreement',component:EmploymentAgreementComponent},
{path:'nda-for-employees',component:NdaForEmployeesComponent},
{path:'job-offer-rejection-letter',component:JobOfferRejectionLetterComponent},
{path:'offer-letter',component:OfferLetterComponent},
{path:'resignation-letter',component:ResignationLetterComponent},
{path:'relieving-letter',component:RelievingLetterComponent},
{path:'consumer-complaint-letter',component:ConsumerComplaintLetterComponent},
{path:'adding-director-resolution',component:AddingDirectorResolutionComponent},
{path:'resignation-director-resolution',component:ResignationDirectorResolutionComponent},
{path:'noc-address-proof',component:NocAddressProofComponent},
{path:'private-limited-company-to-limited-liablity-partnership-resolution',component:PrivateLimitedCompanyToLimitedLiablityPartnershipResolutionComponent},
{path:'share-holder-agreement',component:ShareHolderAgreementComponent},
{path:'term-sheet',component:TermSheetComponent},
{path:'non-disclosure-agreement',component:NonDisclosureAgreementComponent},
{path:'private-limited-company-to-public-limited-company-resolution',component:PrivateLimitedCompanyToPublicLimitedCompanyResolutionComponent},
{path:'digital-signature',component:DigitalSignatureComponent},
{path:'pf-registration',component:PfRegistrationComponent},
{path:'import-export-code-registration',component:ImportExportCodeRegistrationComponent},
{path:'startup-india-registration',component:StartupIndiaRegistrationComponent},
{path:'ssi-msme-registration',component:SsiMsmeRegistrationComponent},
{path:'shop-establishment-registration',component:ShopEstablishmentRegistrationComponent},
{path:'professional-tax-registration',component:ProfessionalTaxRegistrationComponent},
{path:'pan-application',component:PanApplicationComponent},
{path:'tan-application',component:TanApplicationComponent},
{path:'fssai-registration',component:FssaiRegistrationComponent},
{path:'esi-registration',component:EsiRegistrationComponent},
{path:'gst-return-filing',component:GstReturnFilingComponent},
{path:'gst-registration',component:GstRegistrationComponent},
{path:'lut-under-registration',component:LutUnderRegistrationComponent},
{path:'e-way-bill',component:EWayBillComponent},
{path:'gst-annual-filing',component:GstAnnualFilingComponent},
{path:"gst-invoicing",component:GstInvoicingComponent},
{path:"cancellation-of-gst", component: CancellationOfGstComponent}
];
